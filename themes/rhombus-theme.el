...
(rhombus/with-color-variables
  (custom-theme-set-faces
   ...
   `(default ((t (:foreground ,rhombus-fg :background ,rhombus-bg :font "InputMono-12"))))
   ...
   `(font-lock-function-name-face ((t (:foreground ,rhombus-teal))))
   `(font-lock-variable-name-face ((t (:foreground ,rhombus-off-white))))
   ...
   `(font-lock-negation-char-face ((t (:foreground ,rhombus-light-brown :weight bold))))
   `(font-lock-regexp-grouping-construct ((t (:foreground ,rhombus-teal :weight bold))))
   ...
   `(org-level-1 ((t (:foreground ,rhombus-violet :underline ,rhombus-charcoal :height 1.15))))
